...
public class MainActivity extends AppCompatActivity {
    ...
    public void onOkClicked() {
        Toast.makeText(getApplicationContext(), "Вы выбрали отлично",
                Toast.LENGTH_LONG).show();
        showSnackbar("Отлично когда отлично");
    }

    public void onCancelClicked() {
        Toast.makeText(getApplicationContext(), "Вы выбрали не норм",
                Toast.LENGTH_LONG).show();
        showSnackbar("Держись");
    }

    public void onNeutralClicked() {
        Toast.makeText(getApplicationContext(), "Вы выбрали норм",
                Toast.LENGTH_LONG).show();
        showSnackbar("У вас все норм");
    }
